...
```email``` : [string] -- The email of the person is required and must include @gmail.com to be valid and also there is a minimum length of 5 characters, allowed are latin letters and numbers; 

```password``` : [string] -- The password of the person is required and must be unique, also there is a minimum length of 5 characters, allowed are latin letters and numbers;
